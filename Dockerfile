...
FROM ghcr.io/sfu-dhil/symfony-base:php-8.2-apache AS newn
...
COPY --chown=www-data:www-data --chmod=775 --from=newn-prod-assets /app/node_modules /var/www/html/public/node_modules
# copy docs
COPY --chown=www-data:www-data --chmod=775 --from=newn-docs /app/_site /var/www/html/public/docs/sphinx
